...
S07_PE_MAX = getattr(config, "S07_PE_MAX", 15.0)               # PE绝对上限
...
def check_s07_low_valuation(
    ...
    return make_result(
        code="S07", name="低估值策略",
        passed=pe_pass and pb_pass and roe_pass,  # PE+PB 核心 + ROE 防价值陷阱，三条件齐备才算通过
        score=score,
        reasons=reasons,
        details=details,
    )
...
__all__ = ["check_s07_low_valuation"]
